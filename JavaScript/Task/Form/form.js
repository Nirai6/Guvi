...
}  function remove(delButton){
  var row=delButton.parentNode.parentNode;
  var index=row.rowIndex-1
  if(confirm('Do you want to delete')){
   details.splice(index,1);
    //console.log(details.splice(index,1));
    console.log(details)
    createtable();
...
function edit(editButton){
 ...
 document.getElementById('name').value= details[index].name;
  ...
  document.getElementById('password').value= details[index].password;
  document.getElementById("s").value= details[index].country;
  document.getElementById("s1").value= details[index].state;
  document.getElementById("s2").value= details[index].city;
  Gender:gender()
  document.getElementById("name").focus();
  isEdit = true;
        eindex = index;
